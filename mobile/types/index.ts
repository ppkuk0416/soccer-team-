...
export type Position = 'FWD' | 'MID' | 'DEF' | 'GK' | 'SUB';
...
export const POSITION_LABELS: Record<Position, string> = {
  FWD: '공격수', MID: '미드필더', DEF: '수비수', GK: '골키퍼', SUB: '교체',
};
...
export interface FormationSlotDef { pos: Position; count: number }
export interface Formation { id: string; label: string; slots: FormationSlotDef[] }

export const FORMATIONS: Formation[] = [
  { id: '4-4-2', label: '4-4-2', slots: [{ pos: 'FWD', count: 2 }, { pos: 'MID', count: 4 }, { pos: 'DEF', count: 4 }, { pos: 'GK', count: 1 }] },
  { id: '4-3-3', label: '4-3-3', slots: [{ pos: 'FWD', count: 3 }, { pos: 'MID', count: 3 }, { pos: 'DEF', count: 4 }, { pos: 'GK', count: 1 }] },
  { id: '3-4-3', label: '3-4-3', slots: [{ pos: 'FWD', count: 3 }, { pos: 'MID', count: 4 }, { pos: 'DEF', count: 3 }, { pos: 'GK', count: 1 }] },
  { id: '3-5-2', label: '3-5-2', slots: [{ pos: 'FWD', count: 2 }, { pos: 'MID', count: 5 }, { pos: 'DEF', count: 3 }, { pos: 'GK', count: 1 }] },
];
